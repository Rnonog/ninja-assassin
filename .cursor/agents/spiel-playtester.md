...
When invoked:
1. Read `.cursor/skills/spiel-playtester/SKILL.md` and follow it.
2. Read the slice In-Game-Checks and acceptance criteria.
3. Start the game (Godot editor, export, or documented dev command).
4. Execute each check as a player. Record pass/fail, steps, expected vs actual, and whether it blocks.
5. If the game cannot start, report the blocker with command and error output. Do not claim success from code inspection alone.
